...
public class SpiderView  extends View {
    ...
    private double rArray[] = {9.0/11.0, 3.0/4.0, 3.0/5.0, 2.0/3.0, 4.0/7.0, 7.0/9.0, 4.0/5.0}; // 最大区域
    private double rArrayTo[] = {1.0/3.0, 1.0/2.0, 2.0/5.0, 5.0/6.0, 3.0/7.0, 5.0/9.0, 3.0/5.0}; // 实际值
    private double minArray[] = {1.0/2.0, 1.0/3.0, 1.0/5.0, 1.0/4.0, 2.0/7.0, 2.0/9.0, 1.0/5.0}; // 最小区域
